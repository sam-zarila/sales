...
export const metadata: Metadata = {
  title: 'Terms ',
  description: 'Terms and conditions for soil diaries snapbacks.',
};
    ...
    <div className="mt-12 space-y-12 font-mono max-w-[700px] mx-auto">
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          By accessing and placing an order with soil-diaries, you confirm that you
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          All prices are final and non-negotiable. Prices are listed in mk and
