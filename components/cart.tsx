...
export function Cart({ isOpen, onClose }: { isOpen: boolean; onOpenChange: any }) {
  ...
  return (
    <>
      <Sheet open={isOpen} onOpenChange={onClose}>
        ...
        <SheetContent className="w-full sm:max-w-6xl p-0 absolute right-0 top-0 h-full">
          ...
          <div className="flex flex-col h-full">
            {/* Container adapts: on mobile items stack; on md+ two columns */}
            <div className="flex flex-col md:flex-row flex-1 overflow-auto">
              {/* Cart Items: on mobile top, on md+ right */}
              ...
              {/* Delivery Form: on mobile bottom, on md+ left */}
      ...
      {/* Payment wrapper moved outside the Sheet for higher stacking order */}
      <div
        id="wrapper"
